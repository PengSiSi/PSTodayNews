...
protocol MenuScrollViewDelegate: NSObjectProtocol {
...
class MenuScrollView: UIView {
    ...
    weak var delegate: MenuScrollViewDelegate?
    // 顶部标题数组
...
extension MenuScrollView {
    ...
    func searchButtonClick(button: UIButton) {
        ...
        delegate?.menuTitle(menuTitleView: self, didSelectAddButton: button)
    }
